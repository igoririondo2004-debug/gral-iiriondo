...
BATCH_SIZE = 32          # lower for CPU stability
MAX_WORKERS = 4          # IMPORTANT for CPU
...
def evaluate(dataset):
    ...
    for i in tqdm(range(0, total, BATCH_SIZE), desc="Evaluating (CPU)"):
    ...
    # SAVE RESULTS
    # -----------------------------
    output_file = "ollama_cpu_results.txt"
...
if __name__ == "__main__":
    ...
    print(f"📊 Loaded {len(dataset)} samples (CPU MODE)\n")
