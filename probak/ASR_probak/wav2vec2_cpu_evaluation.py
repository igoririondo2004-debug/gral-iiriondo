...
# FORCE CPU
# =========================
device = -1  # transformers pipeline: -1 = CPU

torch.set_num_threads(8)  # adjust to your CPU
...
report = f"""
===============================
WAV2VEC2 LARGE XLSR SPANISH (CPU)
===============================
...
with open("wav2vec2_spanish_cpu_results.txt", "w") as f:
    f.write(report)

print("💾 Saved to wav2vec2_spanish_cpu_results.txt")