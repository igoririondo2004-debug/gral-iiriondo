...
#include "speech_to_goal_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const speech_to_goal_interfaces::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  speech_to_goal_interfaces::msg::Waypoint & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = speech_to_goal_interfaces::msg::Waypoint;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const speech_to_goal_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<speech_to_goal_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &speech_to_goal_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_to_goal_interfaces, msg, Waypoint)() {
  return &speech_to_goal_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
