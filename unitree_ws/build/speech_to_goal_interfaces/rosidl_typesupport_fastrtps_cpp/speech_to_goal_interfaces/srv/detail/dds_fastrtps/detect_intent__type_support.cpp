...
#include "speech_to_goal_interfaces/srv/detail/detect_intent__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = speech_to_goal_interfaces::srv::DetectIntent_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const speech_to_goal_interfaces::srv::DetectIntent_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<speech_to_goal_interfaces::srv::DetectIntent_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectIntent_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const speech_to_goal_interfaces::srv::DetectIntent_Request *>(
...
static size_t _DetectIntent_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectIntent_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DetectIntent_Request__callbacks = {
...
static rosidl_message_type_support_t _DetectIntent_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectIntent_Request__callbacks,
...
{
  return &speech_to_goal_interfaces::srv::typesupport_fastrtps_cpp::_DetectIntent_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = speech_to_goal_interfaces::srv::DetectIntent_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const speech_to_goal_interfaces::srv::DetectIntent_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<speech_to_goal_interfaces::srv::DetectIntent_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectIntent_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const speech_to_goal_interfaces::srv::DetectIntent_Response *>(
...
static size_t _DetectIntent_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectIntent_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DetectIntent_Response__callbacks = {
  "speech_to_goal_interfaces::srv",
...
static rosidl_message_type_support_t _DetectIntent_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectIntent_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &speech_to_goal_interfaces::srv::typesupport_fastrtps_cpp::_DetectIntent_Response__handle;
}
...
static service_type_support_callbacks_t _DetectIntent__callbacks = {
  "speech_to_goal_interfaces::srv",
  "DetectIntent",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_to_goal_interfaces, srv, DetectIntent_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_to_goal_interfaces, srv, DetectIntent_Response)(),
...
static rosidl_service_type_support_t _DetectIntent__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectIntent__callbacks,
...
{
  return &speech_to_goal_interfaces::srv::typesupport_fastrtps_cpp::_DetectIntent__handle;
}
