...
#ifndef OBJECT_RECOGNITION_INTERFACES__SRV__DETAIL__DETECT_OBJECT__FUNCTIONS_H_
#define OBJECT_RECOGNITION_INTERFACES__SRV__DETAIL__DETECT_OBJECT__FUNCTIONS_H_
 ...
 * calls
 * object_recognition_interfaces__srv__DetectObject_Request__init().
...
/**
 * It calls
 * object_recognition_interfaces__srv__DetectObject_Request__fini()
 ...
 * object_recognition_interfaces__srv__DetectObject_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * object_recognition_interfaces__srv__DetectObject_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * object_recognition_interfaces__srv__DetectObject_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_object_recognition_interfaces
...
/**
 * It calls
 * object_recognition_interfaces__srv__DetectObject_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_object_recognition_interfaces
...
/**
 * It allocates the memory for the array and calls
 * object_recognition_interfaces__srv__DetectObject_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_object_recognition_interfaces
...
/**
 * It calls
 * object_recognition_interfaces__srv__DetectObject_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OBJECT_RECOGNITION_INTERFACES__SRV__DETAIL__DETECT_OBJECT__FUNCTIONS_H_
