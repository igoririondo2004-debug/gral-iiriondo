...
class Metaclass_DetectObject(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'object_recognition_interfaces.srv.DetectObject')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from object_recognition_interfaces.srv import _detect_object
...
class DetectObject(metaclass=Metaclass_DetectObject):
    from object_recognition_interfaces.srv._detect_object import DetectObject_Request as Request
    from object_recognition_interfaces.srv._detect_object import DetectObject_Response as Response
