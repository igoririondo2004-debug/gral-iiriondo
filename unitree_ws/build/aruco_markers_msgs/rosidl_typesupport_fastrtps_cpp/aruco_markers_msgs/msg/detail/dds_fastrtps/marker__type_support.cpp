...
#include "aruco_markers_msgs/msg/detail/marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aruco_markers_msgs::msg::Marker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_markers_msgs::msg::Marker & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_markers_msgs::msg::Marker;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_markers_msgs::msg::Marker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_markers_msgs::msg::Marker *>(
    untyped_ros_message);
...
{
  return &aruco_markers_msgs::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_markers_msgs, msg, Marker)() {
  return &aruco_markers_msgs::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
