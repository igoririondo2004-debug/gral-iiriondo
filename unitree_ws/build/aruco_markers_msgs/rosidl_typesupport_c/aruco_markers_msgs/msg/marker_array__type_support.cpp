...
static const _MarkerArray_type_support_symbol_names_t _MarkerArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_markers_msgs, msg, MarkerArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aruco_markers_msgs, msg, MarkerArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aruco_markers_msgs, msg, MarkerArray)() {
  return &::aruco_markers_msgs::msg::rosidl_typesupport_c::MarkerArray_message_type_support_handle;
}
