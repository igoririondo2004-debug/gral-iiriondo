...
bool aruco_markers_msgs__msg__marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_markers_msgs.msg._marker.Marker", full_classname_dest, 37) == 0);
  }
  aruco_markers_msgs__msg__Marker * ros_message = _ros_message;
  {  // header
  ...
  {  // pixel_x
    ...
    ros_message->pixel_x = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pixel_y
    ...
    assert(PyFloat_Check(field));
    ros_message->pixel_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * aruco_markers_msgs__msg__marker__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_markers_msgs.msg._marker");
