...
#include "aruco_markers_msgs/msg/detail/marker_array__struct.hpp"
...
{
  new (message_memory) aruco_markers_msgs::msg::MarkerArray(_init);
}

void MarkerArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aruco_markers_msgs::msg::MarkerArray *>(message_memory);
  typed_message->~MarkerArray();
}

size_t size_function__MarkerArray__markers(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<aruco_markers_msgs::msg::Marker> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<aruco_markers_msgs::msg::Marker> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<aruco_markers_msgs::msg::Marker> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const aruco_markers_msgs::msg::Marker *>(
    get_const_function__MarkerArray__markers(untyped_member, index));
  auto & value = *reinterpret_cast<aruco_markers_msgs::msg::Marker *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<aruco_markers_msgs::msg::Marker *>(
    get_function__MarkerArray__markers(untyped_member, index));
  const auto & value = *reinterpret_cast<const aruco_markers_msgs::msg::Marker *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MarkerArray_message_member_array[2] = {
  {
    ...
    offsetof(aruco_markers_msgs::msg::MarkerArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<aruco_markers_msgs::msg::Marker>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(aruco_markers_msgs::msg::MarkerArray, markers),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MarkerArray_message_members = {
  "aruco_markers_msgs::msg",  // message namespace
  "MarkerArray",  // message name
  2,  // number of fields
  sizeof(aruco_markers_msgs::msg::MarkerArray),
...
get_message_type_support_handle<aruco_markers_msgs::msg::MarkerArray>()
{
  return &::aruco_markers_msgs::msg::rosidl_typesupport_introspection_cpp::MarkerArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_markers_msgs, msg, MarkerArray)() {
  return &::aruco_markers_msgs::msg::rosidl_typesupport_introspection_cpp::MarkerArray_message_type_support_handle;
}
