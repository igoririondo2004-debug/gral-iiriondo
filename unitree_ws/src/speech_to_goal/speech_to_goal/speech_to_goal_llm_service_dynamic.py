...
class SpeechToGoalLLM(Node):
    ...
    def ensure_model_ready(self):
        ...
        try:
            ...
            ALLOWED_PLACES=[]
            self.define_system_prompt(ALLOWED_PLACES)  # empty allowed places for warm-up
            warmup_messages = [
                {
                    "role": "system",
    ...
    def define_system_prompt(self, allowed_places):
...
"""
    ...
    def query_llm(self, user_text):
        ...
        ALLOWED_PLACES = ["mesa", "silla", "entrada"]

        self.define_system_prompt(ALLOWED_PLACES)
